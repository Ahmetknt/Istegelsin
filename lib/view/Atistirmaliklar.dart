...
import 'package:istegelsin/view/Sepet.dart';

import '../items/addAtistirmalik.dart';
...
class _AtistirmaliklarState extends State<Atistirmaliklar> {
  AddAtistirmalik food = AddAtistirmalik();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Atıştırmalık"),
        ),
        body: FutureBuilder<List<Food>>(
          future: food.addAtistirmalik(),
