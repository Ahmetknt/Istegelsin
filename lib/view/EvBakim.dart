...
import 'package:istegelsin/items/addEvBakim.dart';
...
class EvBakim extends StatefulWidget {
  @override
  _EvBakimState createState() => _EvBakimState();
}

class _EvBakimState extends State<EvBakim> {
  AddEvBakim food = AddEvBakim();
  @override
