...
import 'package:istegelsin/items/addMeyveSebze.dart';
...
class MeyveSebze extends StatefulWidget {
  @override
  _MeyveSebzeState createState() => _MeyveSebzeState();
}

class _MeyveSebzeState extends State<MeyveSebze> {
  AddMeyveSebze food = AddMeyveSebze();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Meyve Sebze"),
        ),
        body: FutureBuilder<List<Food>>(
          future: food.addMeyveSebze(),
